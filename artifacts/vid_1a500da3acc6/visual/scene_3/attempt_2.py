...
class Scene3Scene(Scene):
    def construct(self):
        ...
        self.play(
            o1.animate.move_to(LEFT * 0.8 + UP * 0.15),
            o2.animate.move_to(RIGHT * 0.8 + UP * 0.15),
            run_time=0.9,
        )

        o2_bond = make_bond(o1, o2, stroke_width=10)
        ...
        self.play(FadeTransform(header, header3), FadeOut(o2_label), run_time=0.5)
        header = header3
        self.play(
        ...
        note.next_to(VGroup(o1, o2, same_lab1, same_lab2), RIGHT, buff=0.75)
        ...
        old_group = VGroup(header, o1, o2, o2_bond, same_lab1, same_lab2, note, note_box)
