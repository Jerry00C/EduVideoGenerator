...
class Scene2Scene(Scene):
    def construct(self):
        ...
        single_atom_label = Text("one atom", font_size=28, color=PURPLE_A)
        single_atom_label.move_to(LEFT * 3.1 + DOWN * 1.45)
        single_atom_label.set_z_index(8)
        ...
        self.play(
            ...
            FadeIn(single_atom_label, shift=UP * 0.1),
